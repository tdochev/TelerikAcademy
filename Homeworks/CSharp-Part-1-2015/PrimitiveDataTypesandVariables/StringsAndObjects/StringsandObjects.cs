...
class StringsandObjects
{
    static void Main()
    {
        ...
        string helloWorldAsStinrg = (string)helloWorld;
        string helloWwordAsStringWithConvert = Convert.ToString(helloWorld);
        Console.WriteLine(helloWorldAsStinrg);
        Console.WriteLine(helloWwordAsStringWithConvert);
