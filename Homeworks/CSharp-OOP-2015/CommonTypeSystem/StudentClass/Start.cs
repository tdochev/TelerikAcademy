   ...
   public class Start
    {
        ...
        {
            var firstStudent = new Student("Ivan", "Ivanov", "Ivanov", 1234);
            var secondStudent = (Student)firstStudent.Clone();
            var thirdStudent = new Student("Gosho", "Georgiev", "Ivanov", 1233, "some address", "+359888123456", "supergosho@abv.bg", "Some Cource", Specialty.Physics, Faculty.Mathemtics, University.MEI);
